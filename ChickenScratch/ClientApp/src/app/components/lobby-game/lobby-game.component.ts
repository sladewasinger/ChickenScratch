...
export class LobbyGameComponent implements OnInit {
  ...
  @ViewChild("mouseCanvas", { static: false }) mouseCanvas: ElementRef<HTMLCanvasElement> | null = null;
  @ViewChild("chatLog", { static: false }) chatLog: ElementRef<HTMLElement> | null = null;
  @ViewChild("imgContainer") imageContainer: ElementRef<HTMLElement> | null = null;
